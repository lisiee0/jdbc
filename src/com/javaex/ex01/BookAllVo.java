...
public class BookAllVo {
	...
	public BookAllVo(int bookId, String title, String pubs, String pub_date, int authorId, String authorName,
			String authorDesc) {
		super();
		this.bookId = bookId;
		this.title = title;
	...
	public String toString() {
		return "BookAllVo [bookId=" + bookId + ", title=" + title + ", pubs=" + pubs + ", pub_date=" + pub_date
